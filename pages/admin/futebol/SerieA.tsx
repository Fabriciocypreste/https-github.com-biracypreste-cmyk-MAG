...
import { Calendar, Tv, Plus, X, Save, Upload, Palette, Loader, Shield, ChevronLeft, ChevronRight, Trophy, Users, Activity, Clock } from 'lucide-react';
    ...
    <div className="p-8 bg-[#121212] min-h-screen text-white relative">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center mb-8 gap-4">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 bg-[#1E1E1E] hover:bg-[#2A2A2A] border border-white/10 rounded-lg text-sm font-bold transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-[#1E1E1E] border border-white/5 rounded-xl p-5 flex items-center gap-4 shadow-lg">
              ...
              <div>
                  <p className="text-gray-400 text-xs font-bold uppercase">Líder Atual</p>
                  <p className="text-2xl font-black text-white">Palmeiras</p>
              </div>
          </div>
          <div className="bg-[#1E1E1E] border border-white/5 rounded-xl p-5 flex items-center gap-4 shadow-lg">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <section className="mb-12 group/slider relative">
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                    <button onClick={() => handleScroll('left')} className="p-2 bg-[#1E1E1E] rounded-full hover:bg-white/10 transition-colors">
                        <ChevronLeft className="w-4 h-4" />
                    </button>
                    <button onClick={() => handleScroll('right')} className="p-2 bg-[#1E1E1E] rounded-full hover:bg-white/10 transition-colors">
            ...
            <div className="relative -mx-2">
                ...
                <div 
                    ref={rowRef}
                    className="flex gap-4 overflow-x-auto no-scrollbar pb-4 px-2 snap-x scroll-smooth"
                >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-[#1E1E1E] w-full max-w-lg rounded-xl border border-white/10 shadow-2xl animate-in fade-in zoom-in duration-200">
            <div className="flex justify-between items-center p-6 border-b border-white/10 bg-white/5">
              ...
              <button onClick={() => setIsTeamModalOpen(false)} className="text-gray-400 hover:text-white transition-colors">
                <X className="w-6 h-6" />
              </button>
            </div>
